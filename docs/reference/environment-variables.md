...
| `ENVY_NO_REEXEC` | Set to stop envy from [re-executing](/concepts/reproducibility#whichever-envy-you-run-becomes-the-pinned-envy) into the version the manifest pins. Debugging only. |
